...
typedef GPB_ENUM(RequestType) {
  ...
  RequestType_TradeSearch = 117,

  /** Not yet implemented in the game */
  RequestType_TradeOffer = 118,

  /** Not yet implemented in the game */
  RequestType_TradeResponse = 119,

  /** Not yet implemented in the game */
  RequestType_TradeResult = 120,

  /** Implemented [R & M] */
  RequestType_GetPlayerProfile = 121,

  /** Can't find this one */
  RequestType_GetItemPack = 122,

  /** Can't find this one */
  RequestType_BuyItemPack = 123,

  /** Can't find this one */
  RequestType_BuyGemPack = 124,
  ...
  RequestType_DebugUpdateInventory = 700,
  RequestType_DebugDeletePlayer = 701,
