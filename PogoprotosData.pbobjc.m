...
typedef struct PokemonDisplay__storage_ {
  uint32_t _has_storage_[1];
  PokemonDisplay_Costume costume;
  PokemonDisplay_Gender gender;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "costume",
        .dataTypeSpecific.enumDescFunc = PokemonDisplay_Costume_EnumDescriptor,
      ...
      {
        .name = "gender",
        .dataTypeSpecific.enumDescFunc = PokemonDisplay_Gender_EnumDescriptor,
...
GPBEnumDescriptor *PokemonDisplay_Costume_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "Unset\000Holiday2016\000";
    static const int32_t values[] = {
        PokemonDisplay_Costume_Unset,
        PokemonDisplay_Costume_Holiday2016,
    };
    static const char *extraTextFormatInfo = "\001\001g\204\000";
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(PokemonDisplay_Costume)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
                                     enumVerifier:PokemonDisplay_Costume_IsValidValue
...
BOOL PokemonDisplay_Costume_IsValidValue(int32_t value__) {
  switch (value__) {
    case PokemonDisplay_Costume_Unset:
    case PokemonDisplay_Costume_Holiday2016:
      return YES;
    default:
      return NO;
  }
...
GPBEnumDescriptor *PokemonDisplay_Gender_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    static const int32_t values[] = {
        PokemonDisplay_Gender_GenderUnset,
        PokemonDisplay_Gender_Male,
        PokemonDisplay_Gender_Female,
        PokemonDisplay_Gender_Genderless,
    };
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(PokemonDisplay_Gender)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
                                     enumVerifier:PokemonDisplay_Gender_IsValidValue];
    if (!OSAtomicCompareAndSwapPtrBarrier(nil, worker, (void * volatile *)&descriptor)) {
      [worker release];
    }
  }
...
BOOL PokemonDisplay_Gender_IsValidValue(int32_t value__) {
  switch (value__) {
    case PokemonDisplay_Gender_GenderUnset:
    case PokemonDisplay_Gender_Male:
    case PokemonDisplay_Gender_Female:
    case PokemonDisplay_Gender_Genderless:
      return YES;
    default:
      return NO;
  }
