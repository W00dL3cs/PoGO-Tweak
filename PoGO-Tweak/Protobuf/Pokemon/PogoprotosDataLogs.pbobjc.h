...
typedef GPB_ENUM(BuddyPokemonLogEntry_FieldNumber) {
  ...
  BuddyPokemonLogEntry_FieldNumber_PokemonDisplay = 4,
  BuddyPokemonLogEntry_FieldNumber_Pokemon = 5,
};
...
@property(nonatomic, readwrite) uint64_t pokemon;
...
typedef GPB_ENUM(CatchPokemonLogEntry_FieldNumber) {
  ...
  CatchPokemonLogEntry_FieldNumber_PokemonDisplay = 5,
};
...
typedef GPB_ENUM(FortSearchLogEntry_FieldNumber) {
  ...
  FortSearchLogEntry_FieldNumber_PokemonEggsArray = 5,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<PokemonData*> *pokemonEggsArray;
/** The number of items in @c pokemonEggsArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger pokemonEggsArray_Count;
